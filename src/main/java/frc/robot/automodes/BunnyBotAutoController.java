...
public class BunnyBotAutoController extends AutoController {
    ...
    public BunnyBotAutoController(BunnyBot21 robot) throws MissingParameterException, BadParameterTypeException {
        ...
        try {
            ...
            modes_[0] = new TwoToteAuto(this, "BunnyBotAutoModeClose", "AutoMode_Path1", "AutoMode_Path2", "automodes:twototeauto:delay", "automodes:twototeauto:delay_close_gate") ;
            modes_[1] = new TwoToteAuto(this, "BunnyBotAutoModeFar", "AutoMode_Path3", "AutoMode_Path4", "automodes:twototeauto:delay", "automodes:twototeauto:delay_close_gate") ;
