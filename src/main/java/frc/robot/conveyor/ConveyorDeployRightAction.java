...
public class ConveyorDeployRightAction extends MotorPowerAction {
    ...
    public ConveyorDeployRightAction(ConveyorSubsystem conveyor, boolean setready)
            throws BadParameterTypeException, MissingParameterException, BadMotorRequestException {
        super(conveyor, "motor:right:power") ;
    ...
    public void run() {
        super.run() ;
        sub_.setLeftGate(LeftGatePosition.CLOSED);
        sub_.setRightGate(RightGatePosition.OPEN);
    ...
    public String toString(int indent) {
        String ret = prefix(indent) + "ConveyorDeployRightAction" ;
