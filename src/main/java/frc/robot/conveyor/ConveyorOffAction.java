...
public class ConveyorOffAction extends MotorPowerAction {
    ...
    public ConveyorOffAction(ConveyorSubsystem conveyor, boolean setready)
    ...
    public String toString(int indent) {
        String ret = prefix(indent) + "ConveyorOffAction" ;
